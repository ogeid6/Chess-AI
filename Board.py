...
class Board:
    ...
    def __init__(self, game_mode, ai=False, depth=2, log=False): 
        self.board = []
        self.game_mode = game_mode # selection of white and black
        self.depth = depth
        self.ai = ai
        self.log = log # keeping log of the moves and games, we have minimax_tree.txt file for storing the moves for future execution
    ...
    def place_pieces(self):
        ...
        # Each piece is represented by a Unicode value
    ...
    def save_pieces(self):
        # Pieces are stored index wise in an 8x8 array
        for i in range(8):
            for j in range(8):
...
# board check while making a random move
...
# unmake move if loss is greater
