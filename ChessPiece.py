...
# This class maintains the history of attacked pieces to reduce the search tree.
# Eaten piece history helps prune the minimax tree
...
# classes for each piece to evaluate AI move and validity of any move
